...
세 개의 작업 단위(work01~03)로 진행합니다. 각 작업의 상세 범위와 판단 기준은 `.claude/rules/` 하위 문서를 참조하세요.
...
@.claude/rules/work-01-refactoring.md
@.claude/rules/work-02-nest.js.md
@.claude/rules/work-03-update.md
```
