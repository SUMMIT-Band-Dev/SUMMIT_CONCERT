...
| 단계   | 작업                                              | 상태/시기                                                                      | 상세 문서                              |
| ------ | ------------------------------------------------- | ------------------------------------------------------------------------------- | -------------------------------------- |
| work01 | 리팩토링 (웹 성능 지표 개선)                      | 진행 중 — 추석 전 완료 목표                                                    | `.claude/rules/work-01-refactoring.md` |
| work02 | Nest.js 백엔드 추가 (로그인 + 텍스트/이미지 CRUD) | work01 완료 후 즉시 착수 (추석 전후) — 11월 서류 시점 전 완성 목표             | `.claude/rules/work-02-nest.js.md`     |
