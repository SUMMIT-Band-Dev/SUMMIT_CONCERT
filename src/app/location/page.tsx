  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="relative isolate min-h-screen overflow-hidden pt-16 md:pt-[84px] lg:pt-[102px]">
        ...
        <section className="relative z-10 mx-auto w-full px-2 pb-16 pt-12 md:px-3 md:pt-14 lg:px-4 lg:pt-16">
          <FadeInUp delay={0.05}>
          ...
          <div className="mt-10 flex flex-col items-center gap-10 lg:mt-12 lg:gap-12">
            <FadeInUp delay={0.12}>
              <div className="relative left-1/2 w-[calc(100vw-72px)] -translate-x-1/2 space-y-4 md:w-[calc(100vw-128px)] lg:w-[calc(100vw-220px)]">
                <div className="relative h-[40svh] min-h-[280px] w-full overflow-hidden rounded-[4px] bg-[#d9d9d9] shadow-[0_18px_34px_rgba(0,0,0,0.28)] md:h-[47svh] md:min-h-[360px] lg:h-[53svh] lg:min-h-[460px]">
                  <iframe
                    src={NAVER_MAP_URL}
                    title="플렉스 라운지 지도"
